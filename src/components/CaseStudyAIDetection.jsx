                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(projectData.tech || "Python, TensorFlow, OpenCV").split(', ').map((tech, index) => (
                                        <span
                                            key={index}
                                            className="px-3 py-1.5 bg-white border border-cyan-200 rounded-full text-sm font-medium text-gray-700"
                                        >
                                            {tech}
                                        </span>
                                    ))}
