                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {(projectData.tech || "React, Node.js, AI/ML").split(', ').map((tech, index) => (
                                        <span
                                            key={index}
                                            className="px-3 py-1.5 bg-white border border-orange-200 rounded-full text-sm font-medium text-gray-700"
                                        >
                                            {tech}
                                        </span>
                                    ))}
